...
<head>
    ...
    <title>Online Library Management System | Kelola Kategori</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="manage-categories.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Hapus</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
